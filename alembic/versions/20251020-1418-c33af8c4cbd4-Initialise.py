...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('deleted', sa.Boolean(), nullable=False),
        sa.PrimaryKeyConstraint('name', name=op.f('pk_organisation'))
    )
    op.create_table(
        'network',
        ...
        sa.ForeignKeyConstraint(
            ['organisation_name'],
            ['organisation.name'],
            name=op.f('fk_network_organisation_name_organisation')
        ),
    ...
    op.create_table(
        ...
        sa.Column('current_deployment_id', sa.Integer(), nullable=True),
        sa.Column('deleted', sa.Boolean(), nullable=False),
        sa.ForeignKeyConstraint(
            ['current_deployment_id'],
            ['deployment.id'],
            name=op.f('fk_device_current_deployment_id_deployment')
        ),
        sa.ForeignKeyConstraint(['devicetype_name'], ['devicetype.name'], name=op.f(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['deployment_id'],
            ['deployment.id'],
            name=op.f('fk_deploymentdevice_deployment_id_deployment')
        ),
        sa.ForeignKeyConstraint(
            ['device_id'],
            ['device.id'],
            name=op.f('fk_deploymentdevice_device_id_device')
        ),
        sa.PrimaryKeyConstraint('id', name=op.f('pk_deploymentdevice'))
    )
